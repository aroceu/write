...
<html lang="en">
    ...
    <body>
        ...
        <p class="center">Some writing tools for me. And maybe for you.</p>

        <details>
        <summary>Details</summary>
        
        <p>Text will save using your browser's cache, but I do not have access to anything written on these pages except for what I have personally written/input. 
            Anything you input is privately yours.
        </p>

        <p>This means that if you clear your browser's cache, your text will be lost. I do not have the ability to restore it,
            so be sure to download/save your writing elsewhere after a writing/editing session. All writing/editing pages allow you to download your text in Markdown or HTML format, depending on the page.</p>

        <p>Analytics display: word count, character count, reading time, speaking time; statistics for sentences and paragraphs (average/median/shortest/longest); and
