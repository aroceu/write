...
<?php include '../assets/php/markdown.php'; ?>
...
<div class="container">
    ...
    />
        ...
        <button id="txtDL"onclick="downloadTxt()">Download .txt</button>
...
<script src="../assets/js/markdown-top.js"></script>
<script src="../assets/js/analytics.js"></script>
<script src="../assets/js/markdown-end.js"></script>
